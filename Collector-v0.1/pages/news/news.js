...
Page({
  ...
  onLoad: function (e) {
    ...
    that.setData({
      index: e.index,
      title: p.content[e.index].title,
      article: p.content[e.index].content,
      url: p.content[e.index].url,
      src: p.content[e.index].src,
      time: p.content[e.index].time,
      pic: p.content[e.index].pic
    })
    this.detect();
    var pp = p.content[e.index].content;
